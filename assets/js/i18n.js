...
const I18N = (() => {
  ...
  'adm.gridTitle':   { ar: 'جدول المعيدين والشعب',        en: 'Assistants and sections' },
  'adm.gridHint':    { ar: 'مين مسؤول عن أنهي شعبة، والعدد المسند إليه في {lab}',
                       en: 'Who covers which section, and how many students they hold in {lab}' },
  'adm.gridTa':      { ar: 'المعيد',                      en: 'Assistant' },
  'adm.gridTotal':   { ar: 'الإجمالي',                    en: 'Total' },
  'adm.gridLegend':  { ar: 'الرقم = طلاب هذا المعمل · ✓ = مسؤول عن الشعبة بدون طلاب هذا الأسبوع · — = غير مسؤول',
                       en: 'Number = students this lab · ✓ = covers the section but holds none this week · — = not assigned' },
  'adm.gridEdit':    { ar: 'تعديل الإسناد',                en: 'Edit assignments' },
